...
export default function InProcess() {
    ...
    return <div className="p-8 animate-fadeIn">
        <div className="max-w-4xl mx-auto">
            <div className="mb-8">
                <PageTitle title={(category?.title ? category.title + " - " : "") + "In Process" }/>
                <PageDescription description={category?.title ? `Задачи в работе категории ${category.title}` : "Задачи в работе категории"}/>
            </div>
